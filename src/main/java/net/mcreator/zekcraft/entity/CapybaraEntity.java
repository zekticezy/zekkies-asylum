...
public class CapybaraEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(ZekcraftModEntities.CAPYBARA.get(), 20, 4, 4));
	}

	public CapybaraEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZekcraftModEntities.CAPYBARA.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("zekcraft:capybark"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CapybaraEntity retval = ZekcraftModEntities.CAPYBARA.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(ZekcraftModEntities.CAPYBARA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
