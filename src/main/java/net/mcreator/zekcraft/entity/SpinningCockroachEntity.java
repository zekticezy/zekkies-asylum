...
public class SpinningCockroachEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.AMBIENT)
					.add(new MobSpawnSettings.SpawnerData(ZekcraftModEntities.SPINNING_COCKROACH.get(), 20, 4, 4));
	}

	public SpinningCockroachEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZekcraftModEntities.SPINNING_COCKROACH.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("zekcraft:cockroach"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SpinningCockroachEntity retval = ZekcraftModEntities.SPINNING_COCKROACH.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(ZekcraftModEntities.SPINNING_COCKROACH.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
