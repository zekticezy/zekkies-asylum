...
import net.mcreator.zekcraft.entity.VeryCancerousRodentEntityProjectile;
import net.mcreator.zekcraft.entity.VeryCancerousRodentEntity;
import net.mcreator.zekcraft.entity.ThyRoombaEntityProjectile;
...
import net.mcreator.zekcraft.entity.PrisonEntityProjectile;
...
import net.mcreator.zekcraft.entity.JetstreamSamEntity;
...
public class ZekcraftModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITIES, ZekcraftMod.MODID);
