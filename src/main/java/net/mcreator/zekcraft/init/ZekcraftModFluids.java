...
import net.mcreator.zekcraft.fluid.SulfricAcidFluid;
import net.mcreator.zekcraft.fluid.PissFluid;
import net.mcreator.zekcraft.ZekcraftMod;

public class ZekcraftModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, ZekcraftMod.MODID);
