...
public class AverageJapaneseForestBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"zekcraft:tree_average_japanese_forest",
				FeatureUtils.register("zekcraft:tree_average_japanese_forest", Feature.TREE,
						new TreeConfiguration.TreeConfigurationBuilder(
								BlockStateProvider.simple(ZekcraftModBlocks.HARD_WOOD.get().defaultBlockState()), new ForkingTrunkPlacer(12, 2, 2),
								BlockStateProvider.simple(ZekcraftModBlocks.AVERAGE_JAPANESE_TREE_LEAVES.get().defaultBlockState()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("zekcraft:grass_average_japanese_forest", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("zekcraft:flower_average_japanese_forest", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
