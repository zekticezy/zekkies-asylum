 ...
 *
 */
package net.mcreator.zekcraftbeta;
...
@Mod("zekcraft_beta")
public class ZekcraftBetaMod {
	public static final Logger LOGGER = LogManager.getLogger(ZekcraftBetaMod.class);
	public static final String MODID = "zekcraft_beta";
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation(MODID, MODID), () -> PROTOCOL_VERSION,
			PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	private static int messageID = 0;

	public ZekcraftBetaMod() {
		...
		ZekcraftBetaModBiomes.REGISTRY.register(bus);
