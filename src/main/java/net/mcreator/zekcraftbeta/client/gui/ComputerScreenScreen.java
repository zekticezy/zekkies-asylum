...
import net.mcreator.zekcraftbeta.world.inventory.ComputerScreenMenu;
...
public class ComputerScreenScreen extends AbstractContainerScreen<ComputerScreenMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("zekcraft_beta:textures/computer_screen.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "W.I.P!", 69, 12, -16777216);
		this.font.draw(poseStack, "Will be finished by 1.0.4!", 21, 24, -12829636);
	}
