...
public class DuckEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(ZekcraftBetaModEntities.DUCK.get(), 5, 2, 4));
	}

	public DuckEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZekcraftBetaModEntities.DUCK.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("zekcraft_beta:duck"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DuckEntity retval = ZekcraftBetaModEntities.DUCK.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(ZekcraftBetaModEntities.DUCK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
