...
import net.mcreator.zekcraftbeta.world.features.ores.ShitOreOreFeature;
import net.mcreator.zekcraftbeta.world.features.ores.HardWoodFeature;
import net.mcreator.zekcraftbeta.world.features.ores.BrazilBlockFeature;
import net.mcreator.zekcraftbeta.world.features.ores.AverageJapaneseTreeLeavesFeature;
import net.mcreator.zekcraftbeta.world.features.lakes.SulfricAcidFeature;
import net.mcreator.zekcraftbeta.world.features.lakes.PissFeature;
import net.mcreator.zekcraftbeta.world.features.TheSpinalStaircaseFeature;
import net.mcreator.zekcraftbeta.world.features.SaulGoodmanOfficeFeature;
import net.mcreator.zekcraftbeta.world.features.PoopMonsterCastleFeature;
import net.mcreator.zekcraftbeta.world.features.McDonaldsFeature;
import net.mcreator.zekcraftbeta.world.features.KebabFeature;
import net.mcreator.zekcraftbeta.world.features.DrTrayaurusLabFeature;
import net.mcreator.zekcraftbeta.world.features.CancerousHallsFeature;
import net.mcreator.zekcraftbeta.world.features.BreakingBadRVFeature;
...
public class ZekcraftBetaModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, ZekcraftBetaMod.MODID);
