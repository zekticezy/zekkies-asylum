...
package net.mcreator.zekcraftbeta.network;
...
import net.mcreator.zekcraftbeta.procedures.CreditsOpenOnKeyPressedProcedure;
...
public class CreditsOpenMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		ZekcraftBetaMod.addNetworkMessage(CreditsOpenMessage.class, CreditsOpenMessage::buffer, CreditsOpenMessage::new, CreditsOpenMessage::handler);
	}
}
