...
public class PissSwampBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(-0.142857142857f, 0.142857142857f),
			...
			Climate.Parameter.span(-0.585109268516f, -0.299394982802f), 0);

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-10053376).waterColor(-3355648).waterFogColor(-6711040)
				.skyColor(-10053376).foliageColorOverride(-10053376).grassColorOverride(-16738048).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("zekcraft_beta:tree_piss_swamp",
				FeatureUtils.register("zekcraft_beta:tree_piss_swamp", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("zekcraft_beta:grass_piss_swamp", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("zekcraft_beta:flower_piss_swamp", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
